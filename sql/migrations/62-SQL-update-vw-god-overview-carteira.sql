-- =============================================================================
-- MIGRATION 62: Update vw_god_overview to include consultor_responsavel
-- =============================================================================
-- Purpose: Expose consultor_responsavel in the God Overview view
--          so the frontend can filter by "Minha Carteira"
-- Depends on: Migration 61 (consultor_responsavel column)
-- =============================================================================
...
SELECT
  ...
  -- CARTEIRA (consultor responsável)
...
-- Verification query:
-- SELECT consultor_responsavel, COUNT(*) FROM vw_god_overview GROUP BY consultor_responsavel;
