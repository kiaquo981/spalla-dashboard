-- =============================================================================
-- FULL RECOVERY: All views/functions that depended on public.mentorados
-- Re-running migration 08 views + overrides from 33, 48, 54
-- =============================================================================
...
-- =============================================================================
-- Override from migration 48 (instagram)
-- ============================================================
...
-- ─────────────────────────────────────────────────────────────
DROP VIEW IF EXISTS vw_mentorados_ig CASCADE;
...
-- Override from migration 54 (financeiro)
-- ============================================================
...
-- Override from migration 33 (custom fields - tasks full)
DROP VIEW IF EXISTS vw_god_tasks_full CASCADE;
...
GRANT SELECT ON vw_god_tarefas TO authenticated, anon;
GRANT SELECT ON vw_god_timeline TO authenticated, anon;
GRANT SELECT ON vw_god_financeiro TO authenticated, anon;
GRANT SELECT ON vw_mentorados_ig TO authenticated, anon;
